...
public class EvaluationSize {

public static void evalFileSize(File file, double threshold){
		...
		// {smellyFix, nonSmellyFix, smellySize, nonSmellySize}
		...
		try {
			...
			while ((nextLine = reader.readNext()) != null) {
				if(Double.parseDouble(nextLine[10]) < threshold){
					continue;
				}
		...
		*/
		...
		String path = Program.getResultsDir() + Program.getProject() + "/Correlated/../corOverviewSize.csv";
